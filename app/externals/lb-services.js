  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Sector.city() instead.
        "prototype$__get__city": {
          url: urlBase + "/Sectors/:id/city",
          method: "GET"
        },
        ...
        // INTERNAL. Use City.sectors.findById() instead.
        "::findById::City::sectors": {
          url: urlBase + "/Cities/:id/sectors/:fk",
          method: "GET"
        },

        // INTERNAL. Use City.sectors.destroyById() instead.
        "::destroyById::City::sectors": {
          url: urlBase + "/Cities/:id/sectors/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use City.sectors.updateById() instead.
        "::updateById::City::sectors": {
          url: urlBase + "/Cities/:id/sectors/:fk",
          method: "PUT"
        },

        // INTERNAL. Use City.sectors() instead.
        "::get::City::sectors": {
          isArray: true,
          url: urlBase + "/Cities/:id/sectors",
          method: "GET"
        },

        // INTERNAL. Use City.sectors.create() instead.
        "::create::City::sectors": {
          url: urlBase + "/Cities/:id/sectors",
          method: "POST"
        },

        // INTERNAL. Use City.sectors.destroyAll() instead.
        "::delete::City::sectors": {
          url: urlBase + "/Cities/:id/sectors",
          method: "DELETE"
        },

        // INTERNAL. Use City.sectors.count() instead.
        "::count::City::sectors": {
          url: urlBase + "/Cities/:id/sectors/count",
          method: "GET"
        },
      }
    );
    ...
    */
     ...
     */
        ...
        R.city = function() {
          ...
          var action = TargetResource["::get::Sector::city"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use City.regional() instead.
        "prototype$__get__regional": {
          url: urlBase + "/Cities/:id/regional",
          method: "GET"
        },
        ...
        // INTERNAL. Use Regional.cities.findById() instead.
        "::findById::Regional::cities": {
          url: urlBase + "/Regionals/:id/cities/:fk",
          method: "GET"
        },

        // INTERNAL. Use Regional.cities.destroyById() instead.
        "::destroyById::Regional::cities": {
          url: urlBase + "/Regionals/:id/cities/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Regional.cities.updateById() instead.
        "::updateById::Regional::cities": {
          url: urlBase + "/Regionals/:id/cities/:fk",
          method: "PUT"
        },

        // INTERNAL. Use Regional.cities() instead.
        "::get::Regional::cities": {
          isArray: true,
          url: urlBase + "/Regionals/:id/cities",
          method: "GET"
        },

        // INTERNAL. Use Regional.cities.create() instead.
        "::create::Regional::cities": {
          url: urlBase + "/Regionals/:id/cities",
          method: "POST"
        },

        // INTERNAL. Use Regional.cities.destroyAll() instead.
        "::delete::Regional::cities": {
          url: urlBase + "/Regionals/:id/cities",
          method: "DELETE"
        },

        // INTERNAL. Use Regional.cities.count() instead.
        "::count::Regional::cities": {
          url: urlBase + "/Regionals/:id/cities/count",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.City.sectors
     * @header lbServices.City.sectors
     * @object
     * @description
     *
     * The object `City.sectors` groups methods
     * manipulating `Sector` instances related to `City`.
     *
     * Call {@link lbServices.City#sectors City.sectors()}
     * to query all related instances.
     */
        ...
        R.sectors = function() {
          var TargetResource = $injector.get("Sector");
          var action = TargetResource["::get::City::sectors"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.City.sectors#count
         * @methodOf lbServices.City.sectors
         *
         * @description
         *
         * Counts sectors of City.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.sectors.count = function() {
          var TargetResource = $injector.get("Sector");
          var action = TargetResource["::count::City::sectors"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.City.sectors#create
         * @methodOf lbServices.City.sectors
         *
         * @description
         *
        ...
        R.sectors.create = function() {
          var TargetResource = $injector.get("Sector");
          var action = TargetResource["::create::City::sectors"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.City.sectors#destroyAll
         * @methodOf lbServices.City.sectors
         *
         * @description
         *
        ...
        R.sectors.destroyAll = function() {
          var TargetResource = $injector.get("Sector");
          var action = TargetResource["::delete::City::sectors"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.City.sectors#destroyById
         * @methodOf lbServices.City.sectors
         *
         * @description
         *
        ...
        R.sectors.destroyById = function() {
          var TargetResource = $injector.get("Sector");
          var action = TargetResource["::destroyById::City::sectors"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.City.sectors#findById
         * @methodOf lbServices.City.sectors
         *
         * @description
         *
        ...
        R.sectors.findById = function() {
          var TargetResource = $injector.get("Sector");
          var action = TargetResource["::findById::City::sectors"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.City.sectors#updateById
         * @methodOf lbServices.City.sectors
         *
         * @description
         *
        ...
        R.sectors.updateById = function() {
          var TargetResource = $injector.get("Sector");
          var action = TargetResource["::updateById::City::sectors"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.City#regional
         * @methodOf lbServices.City
         *
         * @description
         *
         * Fetches belongsTo relation regional
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Regional` object.)
         * </em>
         */
        R.regional = function() {
          var TargetResource = $injector.get("Regional");
          var action = TargetResource["::get::City::regional"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Regional
 * @header lbServices.Regional
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Regional` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Regional#create
         * @methodOf lbServices.Regional
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source
         ...
         */
        "create": {
          url: urlBase + "/Regionals",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Regional#upsert
         * @methodOf lbServices.Regional
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Regional#exists
         * @methodOf lbServices.Regional
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/Regionals/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Regional#findById
         * @methodOf lbServices.Regional
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/Regionals/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Regional#find
         * @methodOf lbServices.Regional
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Regional#findOne
         * @methodOf lbServices.Regional
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/Regionals/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Regional#updateAll
         * @methodOf lbServices.Regional
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/Regionals/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Regional#deleteById
         * @methodOf lbServices.Regional
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Regional#count
         * @methodOf lbServices.Regional
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/Regionals/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Regional#prototype$updateAttributes
         * @methodOf lbServices.Regional
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Regional#updateOrCreate
         * @methodOf lbServices.Regional
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Regional#update
         * @methodOf lbServices.Regional
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Regional#destroyById
         * @methodOf lbServices.Regional
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Regional#removeById
         * @methodOf lbServices.Regional
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Regional#modelName
    * @propertyOf lbServices.Regional
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Regional`.
    */
    R.modelName = "Regional";

    /**
     * @ngdoc object
     * @name lbServices.Regional.cities
     * @header lbServices.Regional.cities
     * @object
     * @description
     *
     * The object `Regional.cities` groups methods
     * manipulating `City` instances related to `Regional`.
     *
     * Call {@link lbServices.Regional#cities Regional.cities()}
     * to query all related instances.
     */
        ...
        R.cities = function() {
          var TargetResource = $injector.get("City");
          var action = TargetResource["::get::Regional::cities"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Regional.cities#count
         * @methodOf lbServices.Regional.cities
         *
         * @description
         *
         * Counts cities of Regional.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.cities.count = function() {
          var TargetResource = $injector.get("City");
          var action = TargetResource["::count::Regional::cities"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Regional.cities#create
         * @methodOf lbServices.Regional.cities
         *
         * @description
         *
        ...
        R.cities.create = function() {
          var TargetResource = $injector.get("City");
          var action = TargetResource["::create::Regional::cities"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Regional.cities#destroyAll
         * @methodOf lbServices.Regional.cities
         *
         * @description
         *
        ...
        R.cities.destroyAll = function() {
          var TargetResource = $injector.get("City");
          var action = TargetResource["::delete::Regional::cities"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Regional.cities#destroyById
         * @methodOf lbServices.Regional.cities
         *
         * @description
         *
        ...
        R.cities.destroyById = function() {
          var TargetResource = $injector.get("City");
          var action = TargetResource["::destroyById::Regional::cities"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Regional.cities#findById
         * @methodOf lbServices.Regional.cities
         *
         * @description
         *
        ...
        R.cities.findById = function() {
          var TargetResource = $injector.get("City");
          var action = TargetResource["::findById::Regional::cities"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Regional.cities#updateById
         * @methodOf lbServices.Regional.cities
         *
         * @description
         *
        ...
        R.cities.updateById = function() {
          var TargetResource = $injector.get("City");
          var action = TargetResource["::updateById::Regional::cities"];
          return action.apply(R, arguments);
        };
